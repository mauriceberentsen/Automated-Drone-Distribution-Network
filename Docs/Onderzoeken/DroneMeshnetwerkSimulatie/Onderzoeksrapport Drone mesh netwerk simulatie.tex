...
Daarom is de conclusie om een zelf een hybride variant te maken van de reactieve Lightweight Mobile Routing Protocol(LMR).
...
Doordat deze techniek alleen routes opslaat van aangesloten buren en hun aangesloten punten zullen er geen grote routeringstabellen gecreëerd worden.
...
\section{Wat kan er toegevoegd worden aan de communicatie van de netwerkmodule om snel [TODO snel definiëren] achter uitval te komen?}

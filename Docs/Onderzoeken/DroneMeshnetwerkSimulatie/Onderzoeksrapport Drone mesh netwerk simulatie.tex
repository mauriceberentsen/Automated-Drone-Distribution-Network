...
%TODO	\item Hoe gedraagt een node uit het meshnetwerk zich bij slecht of geen bereik?
...
\section{Welke meshnetwerk hardware is geschikt voor het onderling verbinden van drones?}
...
\citeA{LoraMesh} hebben in onderzoek gedaan naar de mogelijk om het LoRa PHY netwerk te gebruiken als meshnetwerk en ook aangetoond dat dit werkt.
...
\citeA{LoraMesh} hebben al aangetoond dat een meshnetwerk op bais van LoRa mogelijk is waardoor het risico afneemt in de haalbaarheid van dit onderzoek.
...
%TODO\section{Hoe gedraagt een fysieke node uit het meshnetwerk zich bij slecht of geen bereik?}

...
\begin{quotation}
\textit{Is het mogelijk om meerdere drones, verbonden in een onderling mesh netwerk, in zetten voor het monitoren van gebieden?}	
\end{quotation}
...
Door gebruik te maken van de bieb onderzoeksmethode moet er een uitkomst komen welke drone package gebruikt kan worden.
Eerst wordt er gekeken welke er compatibel zijn met ROS melodic.
Zodra daar meerdere kandidaten voor gevonden zijn worden deze gefilterd door ze te toetsen aan de gestelde \nameref{chapter:criteria}.

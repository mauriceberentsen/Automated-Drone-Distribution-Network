...
Twee kandidaten worden in het opvolgende stuk behandeld. 
...
\end{figure}
Hij kan tot zes adressen tegelijk onderhouden die kunnen schakelen tussen een RX (ontvang) en TX (zend) stand. 

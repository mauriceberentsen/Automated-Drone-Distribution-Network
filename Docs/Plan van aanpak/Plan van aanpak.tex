...
Daardoor is het urgent voor Alten om zo snel mogelijk meer kennis op te doen naar drones.
...
\begin{tabular}[c]{@{}l@{}}Unit-testen van\\ gemaakte interfaces \\ slagen niet. (nadat \\ deze gepusht zijn\\ op de dev/master\\ branche).\end{tabular} & Klein & Klein  & \begin{tabular}[c]{@{}l@{}}Zorgen voor concrete \\ ontwerpen over de\\ interface in het SDD.\\ Deze ontwerpen, \\ protocol veranderingen\\ en de unit-tests aan\\ de hand daarvan\\ implementeren.\end{tabular}                                                                            & \begin{tabular}[c]{@{}l@{}}Probleem van het niet\\ slagen achterhalen en\\ oplossen.\end{tabular}                         \\ \hline

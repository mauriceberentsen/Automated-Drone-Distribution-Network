...
\begin{itemize}
	...
	\item Implementeer een abstracte drone de simulatiesoftware; Bouw een prototype van het mesh netwerk en simuleer deze; Gebruik het netwerk om meerdere drones aan te sturen.
...
\begin{figure}[H]
	\begin{center}\includegraphics[width=0.62\linewidth]{schetsNetwerk}\end{center}
	\caption{Schets van casus netwerk}
	\label{fig:schetsNetwerk}
\end{figure}

In de schets van \autoref{fig:schetsNetwerk} wordt er vanuit gegaan dat elke drone een line of sight heeft met zijn verbonden netwerkpunt.
De verbindingen zijn gemaakt  om de casus uit te leggen en volgen dus niet de realistische verbindingen.
In de casus komen de volgende situaties voor apart voor:
...
\begin{itemize}
	...
	\item Na de einddatum en wanneer alle resultaten geleverd zijn zal er geen nazorg meer geleverd	worden door de afstudeerder aan het project binnen het huidige dienstverband.
...
\begin{longtable}[c]{|c|l|}
	...
	\begin{tabular}[c]{@{}c@{}}6 - E-1\\ 18 mrt - 22 mrt\end{tabular}  & \begin{tabular}[c]{@{}l@{}}Implementatie abstracte drone in simulatie software.\\ Implementatie mesh netwerk.\end{tabular}                                       \\ \hline

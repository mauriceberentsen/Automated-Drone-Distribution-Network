...
\begin{table}[H]
	...
	\begin{tabular}{|l|}
		...
		Preconditions: Er is aangegeven hoeveel routers en gateways gesimuleerd moeten worden.                                         \\ \hline
...
\begin{table}[H]
	...
	\begin{tabular}{|l|}
		...
		Postconditions: Drone(s) is/zijn verplaatst naar een positie in verbinding met een gateway. \\ \hline
	\end{tabular}
\end{table}

...
\subtitle{Software Requirement Specificatie}{Versie 2.1}{Alten Nederland B.V.}{Hogeschool van Arnhem en Nijmegen}{HBO Technische Informatica - Embedded Software Developement }{MWJ.Berentsen@student.han.nl}{Studentnummer: 561399}{Docent: J. Visch, MSc}{Assessor: ir. C.G.R. van Uffelen}
...
\begin{longtable}[c]{|l|l|}
	...
	RouterDrone & \begin{tabular}[c]{@{}l@{}}Een RouterDrone is een drone voorzien van een \\ RaspberryPiRouter\end{tabular} \\ \hline
	GatewayDrone & \begin{tabular}[c]{@{}l@{}}Een RouterGateway is een drone voorzien van \\ een RaspberryPiGateway\end{tabular} \\ \hline
	RaspberryPi & Een RaspberryPi is een mircocomputer \\ \hline
	RaspberryPiRouter & \begin{tabular}[c]{@{}l@{}}Is een RaspberryPi voorzien van MeshnetworkRouter \\ software\end{tabular} \\ \hline
	RaspberryPiGateway & \begin{tabular}[c]{@{}l@{}}Is een RaspberryPi voorzien van MeshnetworkGateway \\ software\end{tabular} \\ \hline
...
In het project wordt gebruik gemaakt van het Raspberry Pi deze moet virtueel gerepresenteerd worden door de simulatie. 

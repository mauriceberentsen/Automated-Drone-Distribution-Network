...
Eerst worden de virtuele Arduino's behandeld waarna de dronefactory vervolgens aan bod komt. 

\paragraph{Opstarten virtuele arduino}
\label{DetailedDesign:MeshNetwerk:sequence:startenarduino}
Doordat er maar een minimaal verschil zit tussen het opstarten van een virtuele router arduino en een virtuele gateway arduino worden deze samen behandeld.
...
\begin{figure}[H]
	...
	\caption{Sequence diagram initialiseren van een virtuele gateway arduino}
	\label{fig:communication:MeshNetwerk:sequence:gatewayarduino}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Sequence diagram initialiseren van een virtuele gateway arduino}
	\label{fig:communication:MeshNetwerk:sequence:routerarduino}
\end{figure}

In beiden gevallen begint het opstarten van de virtuele arduino met het uitlezen van SDF waardes waar de parameters NodeID, DroneID en debug uit gehaald wordt.
...
\subsection{Design decisions made for the sub-system}
\label{DetailedDesign:ros:decisions}

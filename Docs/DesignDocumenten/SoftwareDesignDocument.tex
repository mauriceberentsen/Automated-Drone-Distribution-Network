...
\begin{figure}[H]
	\begin{center}\includegraphics[width=.99\linewidth]{UML/out/NRF24/sequence/recieveMessage/recieveMessage.png}\end{center}
...
Voor het versturen van een bericht loop het NRF24 component meerdere stappen door. Deze worden onder \autoref{fig:NRF24:activity:sendMessage} toegelicht.
\begin{figure}[H]

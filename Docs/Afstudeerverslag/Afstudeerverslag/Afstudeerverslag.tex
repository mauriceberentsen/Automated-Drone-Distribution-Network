...
\chapter{Methoden, technieken, platforms, tools}
...
Het eerste product die de student heeft opgeleverd was het plan van aanpak.
...
De kwaliteitseis die de student gesteld heeft aan het plan van aanpak was dat het moest omschrijven wat het plan van de student is en dat het voldoet aan het feedbackformulier projectplan van het \citeauthor{HANfeed} \citeyear{HANfeed} 
  
\section{Onderzoeksrapport}
\section{Simulatiesoftware}
\section{Hardwareprototype}
\section{Software design document}
\section{Software requirements specificatie}
...
\section{Advies vervolg project}

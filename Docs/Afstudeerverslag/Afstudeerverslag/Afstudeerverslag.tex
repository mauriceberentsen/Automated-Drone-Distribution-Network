...
Daarom is er besloten een functie toe te voegen aan de draadloze communicatie simulator waarmee opgevraagd kan worden wie er binnen bereik is. Zo kon er toch een implmentatie gemaakt worden waar een broadcast uitgevoerd wordt.  
...
Het project heeft een geavanceerde simulator opgeleverd voor het testen van onderling communicerende drones. Hoewel algoritme voor het opzetten van meshnetwerken nog niet volledig stabiel werkt is het product voldoende gedocumenteerd 
...
\begin{itemize}
	...
	\item Experimenteer met andere routeringsalgoritmes voordat er met fysieke apparatuur gewerkt gaat worden. Er zitten in het huidige algoritmes nog steeds bugs waardoor de communicatie niet altijd  zichzelf weet op te bouwen bij een hoog aantal hops. 
	...
	\item De draadloze communicatie is nu gebaseerd op onderlinge afstand tussen nodes. Mijn advies is om te onderzoeken of het haalbaar is met een simulatie met zoveel onderlinge communicatie hier een andere techniek voor te gebruiken die bijvoorbeeld ook rekening kan houden met obstakels zodat er simulaties kunnen draaien in omgevingen met bijvoorbeeld bomen op gebouwen.
\end{itemize}

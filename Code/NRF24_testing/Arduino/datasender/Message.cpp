...
namespace Messages
{
 ...
 const char* Message::toString( ) const
 {
 // Serial.print("creator[%d] Type[%d]",creator,type);
  return nullptr;
 }
 ...
 const char* LocationMessage::toString( ) const
 {
  //Serial.print(("creator[%d] Type[%d] latitude[%f] longitude[%f] height[%f] timeSincePosix[%d]",creator,latitude,longitude,height,timeSincePosix)
  return nullptr;
  }
 ...
 const char* IntroduceMessage::toString( ) const
 {
  //Serial.print("creator[%d] Ty[%d]To[%d]for[%d]hopsUG[%d] KG[%b]",creator,type,to,forward, hopsUntilGateway ,knowGateway ); 
 ...
 const char* MissingMessage::toString( ) const
 {
  //std::stringstream ss;
 ...
 const char* HeartbeatMessage::toString( ) const
 {
  // "creator[" << std::to_string( creator ) << "] Ty["
 ...
 const char* GoToLocationMessage::toString( ) const
 {
  //std::stringstream ss;
 ...
 const char* MovementNegotiationMessage::toString( ) const
 {
  //std::stringstream ss;
  //ss << "creator[" << std::to_string( creator ) << "] Type["
  //   << std::to_string( type ) << "]"

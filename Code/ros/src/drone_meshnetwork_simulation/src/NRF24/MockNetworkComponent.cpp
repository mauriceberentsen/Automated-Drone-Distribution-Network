...
const uint8_t MockNetworkComponent::getNodeID( ) const{return NodeID;}
/* IMeshDebugInfo */
/**
 ...
 */
const bool MockNetworkComponent::getConnectedToGateway( ) const{return 0;}
/**
 * @brief Get the Total Message Sent
 *
 * @return const uint32_t amount
 */
const uint32_t MockNetworkComponent::getTotalMessageSent( ) const{return 0;}
/**
 * @brief Get the Preffered Gateway ID
 *
 * @return const uint8_t ID
 */
const uint8_t MockNetworkComponent::getPrefferedGateway( ) const{return 0;}
/**
 * @brief Get theHopsFromGatewayAway
 *
 * @return const uint8_t amount of hops away
 */
const uint8_t MockNetworkComponent::getHopsFromGatewayAway( ) const{return 0;}
/**
 * @brief Get the ID of LastGoodKnownLocation
 *
 * @return const uint8_t ID
 */
const uint8_t MockNetworkComponent::getLastGoodKnownLocationID( ) const{return 0;}
/**
 * @brief Get the size of the RouterTechTable
 *
 * @return const uint8_t
 */
const uint8_t MockNetworkComponent::getRouterTechTableSize( ) const{return 0;}
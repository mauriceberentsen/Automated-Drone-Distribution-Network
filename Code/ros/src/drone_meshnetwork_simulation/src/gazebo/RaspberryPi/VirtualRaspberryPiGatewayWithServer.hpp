/**
 * @file VirtualRaspberryPiGatewayWithServer.hpp
 * @author M.W.J. Berentsen (mauriceberentsen@live.nl)
 * @brief Header file for VirtualRaspberryPiGatewayWithServer
 * @version 1.0
 * @date 2019-04-24
 *
...
{
 class VirtualRaspberryPiGatewayWithServer : public IVirtualRaspberryPi
 {
 public:
  VirtualRaspberryPiGatewayWithServer( );
  ~VirtualRaspberryPiGatewayWithServer( );
  /**
...
#endif  // VIRTUALRASPBERRYPIGATEWAYWITHSERVER
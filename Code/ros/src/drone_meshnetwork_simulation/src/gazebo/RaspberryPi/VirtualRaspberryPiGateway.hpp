/**
 * @file VirtualRaspberryPiGateway.hpp
 * @author M.W.J. Berentsen (mauriceberentsen@live.nl)
 * @brief Header file for VirtualRaspberryPiGateway
 * @version 1.0
 * @date 2019-04-24
 *
...
{
 class VirtualRaspberryPiGateway : public IVirtualRaspberryPi
 {
 public:
...
#endif  // VIRTUALRASPBERRYPIGATEWAY

...
namespace Wireless
{
class VirtualNRF24 : public IWirelessCommunication
{
public:
 explicit VirtualNRF24( gazebo::Meshnetwork::MeshnetworkComponent& MC );
 ~VirtualNRF24( );
 void StartAntenna( );
 void StopAntenna( );
...
private:
 ...
 /// \brief The conneceted MeshnetworkComponent used for WirelessSimulator
